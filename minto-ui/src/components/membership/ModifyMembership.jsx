...
/**
 * Update member details by members with regular member permissions.
 */
const ModifyMembership = (props) => {
    ...
    <>
        <div className="card my-3 border shadow"> 
            <div className='card-header text-white bg-danger'>
                <h5 className="card-title">Edit Membership</h5>
            </div>
            {/* New Progress Bar */}
            <div className='card-body px-1 px-sm-3'>
...
export default ModifyMembership
